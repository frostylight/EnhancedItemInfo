...
public static class ModSettingAPI {
    ...
    [MemberNotNullWhen(true, nameof(modBehaviour))]
    ...
    public static bool Init(ModInfo modInfo) {
        ...
        if (modInfo.name == MOD_NAME) {
            Logger.Error("初始化失败，不能使用ModSetting的info进行初始化");
            return false;
        }
        ...
        if (modBehaviour == null)
            return false;
        VersionAvailable();
        var AllMethod = modBehaviour.GetMethods(BindingFlags.Public | BindingFlags.Static);
        foreach (string methodName in methodNames) {
            if (!AllMethod.Any(m => m.Name == methodName)) {
                Logger.Error($"{methodName}方法找不到");
                return false;
            }
        }
        IsInit = true;
    ...
    public static bool AddDropdownList(string key, string description,
        ...
        return InvokeMethod(ADD_DROP_DOWN_LIST,
            ...
            delegateType,
            [typeof(ModInfo), typeof(string), typeof(string), typeof(List<string>), typeof(string), typeof(Action<string>)]);
    }
    ...
    public static bool AddToggle(string key, string description,
        ...
        return InvokeMethod(ADD_TOGGLE,
            ...
            [typeof(ModInfo), typeof(string), typeof(string), typeof(bool), typeof(Action<bool>)]);
    }
    ...
    public static bool AddKeybinding(string key, string description,
        ...
        return InvokeMethod(ADD_KEYBINDING_WITH_DEFAULT,
            ...
            [typeof(ModInfo), typeof(string), typeof(string), typeof(KeyCode), typeof(KeyCode), typeof(Action<KeyCode>)]);
    }
    public static bool AddKeybinding(string key, string description,
        ...
        return InvokeMethod(ADD_KEYBINDING_WITH_KEY,
            ADD_KEYBINDING_WITH_KEY,
            [modInfo, key, description, currentKey, defaultKey, onValueChange],
    ...
    public static bool AddButton(string key, string description,
        ...
        return InvokeMethod(ADD_BUTTON,
            ...
            [typeof(ModInfo), typeof(string), typeof(string), typeof(string), typeof(Action)]);
    }
    ...
    public static bool AddGroup(string key, string description, List<string> keys,
        ...
        return InvokeMethod(ADD_GROUP,
            ...
            [typeof(ModInfo), typeof(string), typeof(string), typeof(List<string>), typeof(float), typeof(bool), typeof(bool)]);
    }
    ...
    public static bool SetValue<T>(string key, T value, Action<bool>? callback = null) {
        ...
        MethodInfo genericMethod = methodInfo.MakeGenericMethod(typeof(T));
        genericMethod.Invoke(null, [modInfo, key, value, callback]);
        return true;
    }
    ...
    public static bool HasConfig() {
        ...
        return (bool)methodInfo.Invoke(null, [modInfo]);
    }
    ...
    /// <typeparam name="T">值类型</typeparam>
    /// <returns></returns>
    public static bool GetSavedValue<T>(string key, out T value) where T : struct {
        value = default;
        if (!Available(key))
            return false;
        ...
        object?[] parameters = [modInfo, key, null];
    ...
    public static bool RemoveUI(string key, Action<bool>? callback = null) {
        ...
        return InvokeMethod(REMOVE_UI,
            ...
            [typeof(ModInfo), typeof(string), typeof(Action<bool>)]);
    }
    ...
    public static bool RemoveMod(Action<bool>? callback = null) {
        ...
        return InvokeMethod(REMOVE_MOD,
            ...
            [typeof(ModInfo), typeof(Action<bool>)]);
    }
    /// <summary>
    ...
    private static bool VersionAvailable() {
        ...
        if (versionField != null && versionField.FieldType == typeof(float)) {
            ...
            if (modSettingVersion != VERSION) {
                Logger.Warn($"警告:ModSetting的版本:{modSettingVersion} (API的版本:{VERSION}),新功能将无法使用");
                return false;
            }
            return true;
        }
    ...
    private static Type? FindTypeInAssemblies(string typeName) {
        ...
        Logger.Warn($"(Mod:{modInfo.displayName})找不到ModSetting程序集");
        return null;
    }
    ...
    private static MethodInfo? GetStaticPublicMethodInfo(string methodName, Type[]? parameterTypes = null) {
        ...
        if (parameterTypes != null) {
            ...
            return methodInfos.FirstOrDefault(methodInfo => {
    ...
    private static bool InvokeMethod(string cacheKey, string methodName, object?[] parameters, Type delegateType,
        ...
        if (!methodCache.ContainsKey(cacheKey)) {
            ...
            if (method == null) {
                Logger.Warn($"找不到此方法{methodName},无法调用");
                return false;
            }
            // 创建委托
        ...
        try {
            ...
            Logger.Warn($"委托调用{methodName}失败: {ex.Message}");
            return false;
        }
    }
}